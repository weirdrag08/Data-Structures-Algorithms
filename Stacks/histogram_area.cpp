// * NSETR     (BIG) will just report the small(as compared to itself) present on the top               (SMALL) will remove larger and equal in the hope to find a smaller element
// * 1) NGETR -> RIGHT SE TRAVERSE         NGETL -> LEFT SE TRAVERSE   (JUST TO MAKE THINGS MORE CLEAR)
...
int main()
{
    int arr[20], arr_left[20], arr_right[20], n, element, total_area, total_width, left_width, right_width, maximum;
    cin >> n;
